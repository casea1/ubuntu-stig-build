...
#
# Usage:  sudo it-oscap [--dir DIR] [--profile PROFILE] [--keep N]
#   --dir      output dir (default /opt/ia/oscap)
#   --profile  XCCDF profile id (default: the STIG profile)
...
# Locate the Ubuntu datastream the scap_scan role staged.
DS=""
